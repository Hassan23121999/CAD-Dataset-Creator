...
def generate_shapes():
    ...
    shape_type = simpledialog.askstring("Input", "Enter shape type (box, cylinder, hexagon, sphere):", parent=root)
    if shape_type not in ["box", "cylinder", "hexagon", "sphere"]:
        print("Invalid shape type. Please enter one of: box, cylinder, hexagon, sphere.")
        root.destroy()
        return
